                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="card">
                                <div class="bg-image hover-zoom ripple ripple-surface ripple-surface-light"
                                    data-mdb-ripple-color="light">
                                    <img src="../images/Product/giay2.jpg"
                                    class="w-50" />
                                    <a href="#!">
                                    <div class="mask">
                                        <div class="d-flex justify-content-start align-items-end h-100">
                                ...
                                <div class="card-body">
                                    <a href="" class="text-reset">
                                    <h5 class="card-title mb-3">Adidas ABC</h5>
                                    </a>
                                    <a href="" class="text-reset">
                                    <p>Giày mang êm chân</p>
                                    </a>
                                    <h6 class="mb-3">2.500.000 đ</h6>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="card">
                                <div class="bg-image hover-zoom ripple" data-mdb-ripple-color="light">
                                    <img src="../images/Product/giay3.jpg"
                                    class="w-50" />
                                    <a href="#!">
                                    <div class="mask">
                                        <div class="d-flex justify-content-start align-items-end h-100">
                                ...
                                <div class="card-body">
                                    <a href="" class="text-reset">
                                    <h5 class="card-title mb-3">Adidas Mega Pull</h5>
                                    </a>
                                    <a href="" class="text-reset">
                                    <p>Giày mang êm chân</p>
                                    </a>
                                    <h6 class="mb-3">
                                    <s>2.000.000 đ</s><strong class="ms-2 text-danger">1.750.000 đ</strong>
                                    </h6>
                                </div>
                            </div>
                        </div>
...
<div class="modal fade" id="modalDangky" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <p class="text-center text-muted mt-5 mb-3">Bạn đã có tài khoản? <a href="#!" class="fw-bold text-body" data-bs-toggle="modal" data-bs-target="#modalDangnhap"><u>Mời đăng nhập</u></a></p>
        </div>
    </div>
</div>

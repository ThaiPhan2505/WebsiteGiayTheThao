...
<form method="post" enctype="multipart/form-data" action="index.php">
	...
	<div class="mb-3 mt-3">
		...
		<input class="form-control" type="text" name="txtdiachi" placeholder="Nhập đỉa chỉ" required>
	</div>
    <div class="mb-3 mt-3">
        <label for="txtgianhap" class="form-label">Ngày lập</label>
        <input class="form-control" type="date" name="txtngaylap">
    ...
    <div class="mb-3 mt-3">
		...
		<input class="form-control" type="text" name="txtghichu" placeholder="Nhập ghi chú" required>
	</div>
	<div class="mb-3 mt-3">
